...
-   downloaded Git (if you use an NMBU computer you can download it easily via the software centre). If not, [follow the following instructions](https://happygitwithr.com/install-git).
